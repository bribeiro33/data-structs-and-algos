...
public:
    ...
    virtual void push(const TYPE &val) {
        //data.insert(lower_bound(data.begin(), data.end(), val, this->compare), move(val));
        typename std::vector<TYPE>::iterator bound = lower_bound(data.begin(), data.end(), val, this->compare);
        data.insert(bound, val);
    } // push()
